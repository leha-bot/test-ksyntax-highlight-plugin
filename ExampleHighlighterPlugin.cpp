#include "ExampleHighlighterPlugin.h"
...
class PluginEntry : public QObject, public SyntaxHighlightPluginInterface
{
    Q_OBJECT
...
public:
    QSyntaxHighlighter *makeSyntaxHighlighterFor(QTextDocument *parent, const QString &syntaxHint)
    {
        return new Highlighter(parent);
    }
};
#include "ExampleHighlighterPlugin.moc"
